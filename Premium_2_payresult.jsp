...
<!--여기에 내용 넣으세요-->
  	...
  	<div class="text-wrap" style="padding-top: 150px;" align="center">	  										
		<div class="space" style="width: 800px; top: 500px;" align="center">					
			...
			<img alt="" src="images/premium.jpg"width="800" height="500" >
			
			<div class="form-group" style="padding: 50px;">
				<a href="Client_0_main.html"><input class="btn btn-primary btn-lg" type="button" value="마이페이지로 이동" /></a>		
				<a href="index.html"><input class="btn btn-primary btn-lg" type="button" value="홈으로" /></a>		
			</div>
		</div>								
	</div>	
