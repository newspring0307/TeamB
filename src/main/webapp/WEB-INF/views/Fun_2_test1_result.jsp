...
<div class="col-md-12 section-heading text-center">
	<h3 style="font-size:40px;">#호불호확실 #일단들이대는편 #나도몰라종착지</h3><br>
 	<h1>썸 추진력 상위 1%, 좋으면 앞뒤 안 재고 돌진하며 썸도 연애도 빠르게 시작하는 금사빠! 말발이 타고나서 격렬한 토론도 좋아해요. 
	<h1>관심 있는 주제로 밤새 떠들 수 있는 상대라면 운명적인 연애를 시작할 수 있을 거예요. 
	<h1>호불호 확실하고 싫증을 빨리 내는 편이라 새로운 핫플이나 액티비티를 함께 찾아다닐 수 있는 사람을 만나면 지루할 틈 없이 다이나믹한 연애를 즐길 수 있어요. 
	<h1>하지만 개인의 시간도 중시해서 모든 시간을 상대와 공유하고 싶진 않을 거예요. 
	<h1>자기 계발을 위한 시간도 필요하다는 걸 	연인에게 잘 설명한다면 갈등 없이 연애할 수 있을 거예요.	
 </div>
</section>
