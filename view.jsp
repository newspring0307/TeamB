			...
			<table class="table table-striped"
				...
				<tbody>
					<tr>
						...
						<td colspan="2" style="background-color:#52D3AA; "><%=bbs.getBbsTitle().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>" )%></td>
					</tr>
					<tr>
						<td style="width: 20%;border-right:  1px solid #dddddd;"><font color="black">작성자</font></td>
						<td colspan="2"><font color="black"><%=bbs.getUserID()%></font></td>
					</tr>
					<tr>
						<td style="width: 20%;border-right:  1px solid #dddddd;"><font color="black">작성일자</font></td>
						<td colspan="2"><font color="black"><%=bbs.getBbsDate().substring(0, 11) + bbs.getBbsDate().substring(11,13)+"시"+bbs.getBbsDate().substring(14,16) +"분"%></font></td>
					</tr>
					<tr>						
						<td style="width: 20%;border-right:  1px solid #dddddd;"><font color="black">내용</font></td>						
						<td colspan="2" style="  widows: 20%; text-align: left"><p><input type="image" src="dwdw.jpg"></p>
						<font color="black"><%=bbs.getBbsContent().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>" )%></font></td>
					</tr>
				</tbody>
			</table>
			<div style="padding:20px;">
			<a href="bbs.jsp" class="btn btn-primary">목록</a>
			<a href="bbs.jsp" class="btn btn-primary">수정</a>
			<a href="bbs.jsp" class="btn btn-primary">삭제</a>
			</div>
